...
--
-- If you change the resource pattern for StaticR in DnP.hs, you will
-- have to make a corresponding change here.
--
-- To see how this value is used, see urlRenderOverride in DnP.hs
staticroot :: String
